  ...
  return (
    <main className="pb-24">
      ...
      <div className="px-4 pb-4">
        <div className="bg-white border border-[#e8e4df] rounded-xl px-4 py-3 flex items-center gap-3 cursor-pointer">
          <span className="text-lg">🚪</span>
          <span className="text-sm font-medium text-[#8b1a1a]">Terminar sessão</span>
        </div>
      </div>
